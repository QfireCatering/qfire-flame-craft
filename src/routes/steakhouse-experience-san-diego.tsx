...
export const Route = createFileRoute("/steakhouse-experience-san-diego")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/Signature Live Fire Steakhouse Catering-experience-san-diego" },
      { property: "og:image", content: Signature Live Fire Steakhouse CateringBackyard.url },
    ],
    links: [{ rel: "canonical", href: "/Signature Live Fire Steakhouse Catering-experience-san-diego" }],
    scripts: [
      {
  ...
  component: () => <Signature Live Fire Steakhouse CateringExperiencePage r={r} />,
});
