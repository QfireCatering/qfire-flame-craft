...
const titles: Record<string, { t: string; d: string }> = {
  ...
  steakhouse: { t: "San Diego Signature Live Fire Steakhouse Catering", d: "Plated Signature Live Fire Steakhouse Catering for weddings and corporate dinners across San Diego County." },
...
export const Route = createFileRoute("/san-diego/$slug")({
  head: ({ params }) => {
    ...
    const url = `https://qfire-flame-craft.lovable.app/san-diego/${params.slug}`;
    return {
      meta: [
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "San Diego County", item: "https://qfire-flame-craft.lovable.app/san-diego" },
