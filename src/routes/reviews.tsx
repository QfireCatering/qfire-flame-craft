...
const reviews = [
  ...
  { q: "Backyard 50th birthday. Wood-fired everything. Guests thought we'd flown in a Steakhouse Experience. Absolutely premium top to bottom.", a: "Jean Laber", e: "Private Party · Gilbert", source: "Google" },
