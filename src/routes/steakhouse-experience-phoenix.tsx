...
export const Route = createFileRoute("/steakhouse-experience-phoenix")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/Signature Live Fire Steakhouse Catering-experience-phoenix" },
      { property: "og:image", content: Signature Live Fire Steakhouse CateringBackyard.url },
    ],
    links: [{ rel: "canonical", href: "/Signature Live Fire Steakhouse Catering-experience-phoenix" }],
    scripts: [
      {
