...
export const Route = createFileRoute("/steakhouse-experience-phoenix")({
  head: () => ({
    meta: [
      { title: "Steakhouse Catering Phoenix — Surf & Turf, Onsite Charcoal Grilling | Qfire" },
      { name: "description", content: "Luxury steakhouse catering in the Phoenix Metro. Ribeye, filet mignon, prime rib, salmon and lobster — grilled live onsite at Phoenix, Scottsdale and Paradise Valley weddings, corporate events and private parties. Buffet from $74/pp · Plated from $128/pp." },
      { property: "og:title", content: "Steakhouse Catering Phoenix | Qfire" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "Steakhouse Catering — Phoenix Metro",
          ...
          offers: [
            { "@type": "Offer", name: "Buffet Style", price: "74", priceCurrency: "USD", description: "Per person — restaurant-quality buffet steakhouse catering in Phoenix." },
            { "@type": "Offer", name: "Family Style", price: "89", priceCurrency: "USD", description: "Per person — shared platter steakhouse experience in Phoenix Metro." },
            { "@type": "Offer", name: "Plated Service", price: "128", priceCurrency: "USD", description: "Per person — fully plated luxury steakhouse catering in Phoenix." },
          ],
        }),
      },
    ],
