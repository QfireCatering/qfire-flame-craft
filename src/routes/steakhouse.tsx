...
export const Route = createFileRoute("/steakhouse")({
  head: () => ({
    meta: [
      { title: "Signature Live Fire Steakhouse Catering — Plated Ribeye, Filet, Picanha, Prime Rib | Qfire" },
      ...
      { property: "og:title", content: "Signature Live Fire Steakhouse Catering — Qfire" },
