          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-10 max-w-6xl mx-auto">
            {[
              ...
              <Link key={r.to} to={r.to} className="group relative aspect-[4/3] overflow-hidden block border border-white/10 hover:border-gold/60 transition-colors">
                <img src={r.img} alt={`${r.name} wedding catering`} className="absolute inset-0 w-full h-full object-cover object-[center_65%] transition-transform duration-700 group-hover:scale-105" />
