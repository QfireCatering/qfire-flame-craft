          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-10">
            {[
              ...
              <Link key={r.to} to={r.to} className="group relative aspect-[5/4] overflow-hidden block border border-white/10 hover:border-gold/60 transition-colors">
                <img src={r.img} alt={`${r.name} wedding catering`} className={`absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 ${r.name === "San Diego County" ? "object-center" : ""}`} />
