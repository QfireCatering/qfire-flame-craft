        ...
        <div className="container-luxe relative z-10 pb-20 pt-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-xl md:text-2xl text-bone/85 font-light max-w-2xl">
              Reliable, on-time, restaurant-quality catering for executive teams, HR departments, and construction sites — plus <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">live-fire BBQ</Link> and <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">premium steakhouse</Link> options across Phoenix Metro and San Diego County. Browse <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">menus</Link>, <Link to="/pricing" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">pricing</Link>, and <Link to="/reviews" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">client reviews</Link>.
            </p>
          </div>
        </div>
      </section>
