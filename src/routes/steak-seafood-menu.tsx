...
const macCheeseImg = macCheeseAsset.url;
import alfredoPenneAsset from "@/assets/dishes/alfredo-penne.png.asset.json";
const alfredoPenneImg = alfredoPenneAsset.url;
...
const whitePetitFoursImg = whitePetitFoursAsset.url;
...
const sides: Dish[] = [
  ...
  { name: "Roasted Broccoli", body: "A Steakhouse Experience staple.", img: roastedBroccoliImg },
...
export const Route = createFileRoute("/steak-seafood-menu")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Phoenix Metro's premier five-course steakhouse tasting menu — ribeye, filet mignon, prime rib, lobster, salmon and more — grilled live at your Phoenix, Scottsdale, Gilbert, Mesa, Tempe, Chandler, Glendale, Peoria, Paradise Valley, Cave Creek, Fountain Hills or Ahwatukee event. Premium plated steak dinner catering throughout the Phoenix Metro area." },
      ...
      { property: "og:url", content: "https://qfire-flame-craft.lovable.app/steak-seafood-menu" },
      { property: "og:image", content: steakhouseBackyard.url },
    ],
    links: [{ rel: "canonical", href: "https://qfire-flame-craft.lovable.app/steak-seafood-menu" }],
    scripts: [
      {
      ...
      <section className="py-20 lg:py-28 border-t border-white/5">
        <div className="container-luxe max-w-4xl">
          ...
          <div className="space-y-6 text-bone/70 text-base lg:text-lg leading-relaxed">
            ...
            <p>From Ahwatukee to Anthem, Carefree to Queen Creek, we bring restaurant-quality Steakhouse Experience to every corner of the Phoenix Metro. This isn't just dinner. It's the experience your guests will remember long after the last bite.</p>
          </div>
        </div>
      </section>
