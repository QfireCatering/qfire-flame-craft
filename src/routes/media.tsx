...
const credits = [
  ...
  { icon: Flame, title: "Bobby Flay's Kitchen", sub: "Featured Cook", detail: "Cooked alongside Bobby Flay — sharpening the Steakhouse Experience technique that defines Qfire today." },
