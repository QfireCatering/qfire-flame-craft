...
export const Route = createFileRoute("/corporate-catering-san-diego")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium San Diego corporate catering by Chef Terry Matthews (Food Network's BBQ Brawl). Office lunches, executive dinners, holiday parties, construction-site catering & live-fire grilling across La Jolla, Carlsbad, Del Mar, Rancho Santa Fe, Coronado, Encinitas & all of San Diego County. 2,500+ events · 4.9★ · COI-ready." },
