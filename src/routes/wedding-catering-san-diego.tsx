...
export const Route = createFileRoute("/wedding-catering-san-diego")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "San Diego Wedding Catering — Qfire | Live-Fire Steakhouse Experience Weddings" },
      ...
      { name: "keywords", content: "San Diego wedding catering, La Jolla wedding caterer, Del Mar wedding catering, Carlsbad wedding caterer, Rancho Santa Fe wedding catering, Coronado wedding caterer, Encinitas wedding catering, Wood-Fire wedding catering San Diego, Steakhouse Experience wedding catering La Jolla, luxury wedding catering San Diego County" },
    ],
