        ...
        <div className="container-luxe relative z-10 pb-20 pt-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-xl md:text-2xl text-bone/85 font-light leading-relaxed max-w-2xl">
              <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">Live charcoal grilling</Link>, premium <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">Steakhouse Experience</Link> plates, authentic <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">wood-fired BBQ</Link>, full-service hosting. Choose your region — or browse the <Link to="/menus" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">menus</Link> and <Link to="/reviews" className="underline decoration-gold/40 hover:decoration-gold underline-offset-4">reviews</Link> to get started.
            </p>
          </div>
        </div>
      </section>
