...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Food Network veteran Chef Terry Matthews. 13+ years, 2,500+ events, 4.9★. Premium wood-fired, charcoal-grilled and steakhouse catering for luxury weddings, corporate events and private parties — Phoenix Metro & San Diego County." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500;600&family=Great+Vibes&family=Inter+Tight:wght@300;400;500;600;700&display=swap",
      },
    ],
    scripts: [
      {
