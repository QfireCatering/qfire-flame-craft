...
export const Route = createFileRoute("/corporate-catering-phoenix")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Phoenix corporate catering, Scottsdale corporate caterer, office catering Phoenix, executive catering Scottsdale, holiday party catering Phoenix, employee appreciation catering Phoenix, construction site catering Phoenix, business catering Mesa, company catering Chandler, corporate BBQ catering Phoenix, corporate steakhouse catering Scottsdale, office lunch catering Tempe, conference catering Phoenix" },
    ],
