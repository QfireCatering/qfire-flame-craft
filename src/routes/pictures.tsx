...
const masonry: { src: string; alt: string; tall?: boolean; wide?: boolean }[] = [
  ...
  { src: steakLobster.url, alt: "Surf and turf plate — charcoal-grilled ribeye and cold-water lobster tail from the Steakhouse Experience" },
  ...
  { src: kabob.url, alt: "Antipasto kabob hors d'oeuvre — passed appetizer from the Steakhouse Experience menu by Qfire" },
