...
export function PrivatePartyPage({ config }: { config: PrivatePartyRegionConfig }) {
  ...
  return (
    <>
      ...
      {/* 1. REAL PARTY PRICING */}
      <WeddingBuffetEstimator region={region} regionShort={regionShort as "Phoenix" | "San Diego"} eventType="Private Party" eventTypeLower="private party" audienceNoun="host" />
