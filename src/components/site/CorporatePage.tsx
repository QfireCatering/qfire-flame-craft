...
const whyChoose = [
  { icon: Award, title: "You're hiring a real chef", body: "13+ years professional. 2,500+ corporate events. Featured on Food Network. Chef Terry personally designs every menu we serve — you're not getting a sales rep and a line cook." },
        ...
        <div className="container-luxe relative z-10 pb-20 lg:pb-28 pt-32">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-8 text-sm text-bone/70">
              ...
              <div><span className="text-gold font-display text-2xl">2,500+</span> Corporate Events</div>
            ...
            <table className="w-full min-w-[720px] border-collapse text-left">
              ...
              <tbody className="text-sm">
                {[
                  ...
                  { row: "Typical per-guest range for BBQ", q: isPhx ? "$28 - $35" : "$35 - $54", v: "$45–$125", b: "$14–$28" },
                  { row: "Typical per-guest range for Steakhouse", q: isPhx ? "$84 - $95" : "$84 - $100", v: "$45–$125", b: "$40–$80" },
                ].map((r) => (
        ...
        <div className="container-luxe max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
            <a href={woodMenuUrl} target="_blank" rel="noopener noreferrer" className="group relative aspect-[5/4] overflow-hidden border border-white/5">
              <img src={platter} alt={`Wood-Fire/BBQ — ${regionLabel}`} loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
