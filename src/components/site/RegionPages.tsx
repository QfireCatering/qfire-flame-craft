...
import {
  ...
  woodFiredConfig, Signature Live Fire Steakhouse CateringConfig, bartendingConfig,
...
const steak = Signature Live Fire Steakhouse CateringPlatterAsset.url;
...
export function RegionSlugPage({ regionKey, slug }: { regionKey: RegionKey; slug: string }) {
  ...
  switch (slug) {
    ...
    case "Signature Live Fire Steakhouse Catering": return <ServicePage config={Signature Live Fire Steakhouse CateringConfig(opts)} regionKey={regionKey} />;
