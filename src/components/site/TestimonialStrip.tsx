...
const REVIEWS: Record<RegionKey, Review[]> = {
  ...
  "san-diego": [
    ...
    {
      q: "Coronado beachfront plated dinner for 90 guests. White-glove service, gorgeous presentation, and the filet was better than any Signature Steakhouse Catering we've been to in San Diego. 5 stars, every category.",
      a: "Jean Laber",
