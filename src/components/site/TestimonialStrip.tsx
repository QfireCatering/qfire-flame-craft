...
const REVIEWS: Record<RegionKey, Review[]> = {
  phoenix: [
    ...
    {
      q: "Hired Qfire for our company's annual partner dinner — 200+ guests, plated Steakhouse Experience service in Phoenix. Hot food, perfect timing, the staff was impeccable. Worth every dollar. We are already booking next year.",
      a: "Yara Patino",
      e: "Corporate · Phoenix",
      source: "Yelp",
    },
  ...
  "san-diego": [
    ...
    {
      q: "Brand activation in Del Mar — Chef Terry's team kept the food coming all night for 2,200 people and never missed a beat. Steakhouse Experience-grade food at festival scale. Incredible operation.",
      a: "Yara Patino",
      e: "Corporate · Del Mar",
      source: "Yelp",
    },
    {
      q: "Coronado beachfront plated dinner for 90 guests. White-glove service, gorgeous presentation, and the filet was better than any Steakhouse Experience we've been to in San Diego. 5 stars, every category.",
      a: "Jean Laber",
