...
export const services = [
  ...
  { slug: "Signature Live Fire Steakhouse Catering", label: "Signature Live Fire Signature Live Fire Steakhouse Catering Catering", short: "Signature Live Fire Steakhouse Catering" },
