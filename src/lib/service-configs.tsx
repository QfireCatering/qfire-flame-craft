  ...
  return {
    ...
    menu: {
      ...
      columns: [
        ...
        { title: "Premium Meat Options (Upcharge)", items: ["Smoked Sliced Beef Brisket (+$3)", "Smoked Pulled Beef (+$2)", "BBQ'd Beef Ribs (+$5)", "Beef Tri-Tip (+$4)", "BBQ Daddy Pork Spare Ribs (+$2)", "Grilled Pork Tenderloin (+$2)", "Grilled Chicken Leg Quarters (+$2)", "Hot Links (+$2)", "Grilled Pork Chops (+$2)"] },
        ...
        { title: "Appetizers ($3.49/selection)", items: ["Fruit Platter", "Veggie Platter", "Assorted Spiced Cheese & Crackers", "BBQ Daddy Meatballs", "Caesar Salad (GF, VG)", "BBQ'd Lil Smokies", "BBQ'd Italian Meatballs Wrapped in Bacon (+$3, GF)", "Chips, Red/Green Salsa, Guac & Pico (+$2)"] },
        ...
        { title: "Dinnerware", items: ["Picnic Style — Styrofoam plate, heavyweight white cutlery (+$0.75/person)", "Formal Plasticware — disposable plate, heavyweight plastic cutlery, dinner napkin (+$3.25)", "Glass Dinnerware — glass plate, water goblet, silverware, cloth napkin (+$6.25/person)", "Providing my own dinnerware"] },
